...
public class HTTPClientTextPresenceValidator implements IValidator 
{
	...
	public IValidationResponse validate(Map<String, Object> validationParameters) 
	{
		...
		Response response = (Response) validationParameters.get(IConstants.RESPONSE_OBJECT);
		...
		String pageContent = response.getResponseContentAsString();
